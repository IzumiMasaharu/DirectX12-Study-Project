...
{
public:
    D3D12Exception() = default;
    D3D12Exception(HRESULT hr, const std::wstring& function_name, const std::wstring& file_name, UINT line_num);
...
{                                                                     \
    ...
    if(FAILED(hr__)) { throw D3D12Exception(hr__, L#x, wfn, __LINE__); } \
}
#endif
// 释放动态指针
#ifndef ReleaseCom
