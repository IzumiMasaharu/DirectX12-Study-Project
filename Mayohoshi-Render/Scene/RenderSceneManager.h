...
public:
    ...
    bool addInstance(const std::string& renderItemName, const InstanceDesc& instanceDesc, const RenderResourceManager& resourceManager);
    bool setInstanceTransform(const std::string& renderItemName, size_t instanceIndex, const DirectX::XMFLOAT4X4& worldTransform);
    bool setInstanceTextureTransform(const std::string& renderItemName, size_t instanceIndex, const DirectX::XMFLOAT4X4& textureTransform);
